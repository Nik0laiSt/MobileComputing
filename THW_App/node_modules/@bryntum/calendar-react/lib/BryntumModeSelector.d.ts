...
import { AlignSpec, Base, Button, ButtonGroup, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, MaskConfig, MenuItemConfig, ModeSelector, ModeSelectorListeners, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/calendar';
...
export declare class BryntumModeSelector extends React.Component<BryntumModeSelectorProps> {
