/**
 * React wrapper for Bryntum WeekView
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { ActionButtonsConfig, AlignSpec, Base, CalendarMixin, CalendarRow, CalendarRowConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DayCell, DayView, DomConfig, DurationConfig, EventBar, EventModel, FluidDayLayoutConfig, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, OverflowPopupConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, TimelineBase, Tool, ToolConfig, ToolbarConfig, TooltipConfig, WeekView, WeekViewListeners, Widget } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumWeekViewProps = {
    // Configs
    /**
...
export class BryntumWeekView extends React.Component<BryntumWeekViewProps> {

    static instanceClass = WeekView;

    static instanceName = 'WeekView';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumWeekViewProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-week-view-container`;
        return (
