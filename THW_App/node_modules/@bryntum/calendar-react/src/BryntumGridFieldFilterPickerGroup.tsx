...
import { AlignSpec, Base, CollectionFilterConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, FieldFilterPicker, FieldFilterPickerConfig, FieldFilterPickerGroup, Grid, GridFieldFilterPickerGroup, GridFieldFilterPickerGroupListeners, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/calendar';
...
export type BryntumGridFieldFilterPickerGroupProps = {
     ...
     * This should be a subset of the field names found in the [grid](https://bryntum.com/products/calendar/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-grid)'s store. When supplied,
     ...
     * @param {CollectionFilterConfig} event.filter The [CollectionFilter](https://bryntum.com/products/calendar/docs/api/Core/util/CollectionFilter) configuration object for the filter represented by this [FieldFilterPicker](https://bryntum.com/products/calendar/docs/api/Core/widget/FieldFilterPicker).
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/calendar/docs/api/Grid/widget/GridFieldFilterPickerGroup#event-catchAll)
     * @param {object} event Event object
     ...
     * @param {CollectionFilterConfig[]} event.validFilters The subset of [CollectionFilter](https://bryntum.com/products/calendar/docs/api/Core/util/CollectionFilter) configuration objects in the `filters` parameter on this event that are complete and valid for application to a Store.
     */
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/calendar/docs/api/Grid/widget/GridFieldFilterPickerGroup#event-paint)
     * @param {object} event Event object
