/**
 * React wrapper for Bryntum AgendaView
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { AgendaView, AgendaViewListeners, AjaxStore, AjaxStoreConfig, Base, CalendarMixin, CellCopyPaste, CellCopyPasteConfig, CellEdit, CellEditConfig, CellMenu, CellMenuConfig, CellTooltip, CellTooltipConfig, Column, ColumnAutoWidth, ColumnAutoWidthConfig, ColumnDragToolbar, ColumnDragToolbarConfig, ColumnPicker, ColumnPickerConfig, ColumnRename, ColumnRenameConfig, ColumnReorder, ColumnReorderConfig, ColumnResize, ColumnResizeConfig, ColumnStore, ColumnStoreConfig, Container, ContainerItemConfig, DayCell, DomConfig, DurationConfig, Editor, EventBar, EventModel, ExportConfig, Field, FileDrop, FileDropConfig, FillHandle, FillHandleConfig, Filter, FilterBar, FilterBarConfig, FilterConfig, Grid, GridBase, GridColumnConfig, GridExcelExporter, GridExcelExporterConfig, GridGroupSummary, GridGroupSummaryConfig, GridLocation, GridLocationConfig, GridLockRows, GridLockRowsConfig, GridPdfExport, GridPdfExportConfig, GridPrint, GridPrintConfig, GridRowReorder, GridRowReorderConfig, GridRowResize, GridRowResizeConfig, GridSelectionMode, GridSplit, GridSplitConfig, GridSummary, GridSummaryConfig, Group, GroupConfig, HeaderMenu, HeaderMenuConfig, KeyMapConfig, Mask, MaskConfig, Menu, MenuConfig, MenuItem, MenuItemConfig, MergeCells, MergeCellsConfig, Model, ModelConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, PreserveScrollOptions, QuickFind, QuickFindConfig, RecordPositionContext, RegionResize, RegionResizeConfig, ResourceModel, Row, RowCopyPaste, RowCopyPasteConfig, RowExpander, RowExpanderConfig, ScrollManager, ScrollManagerConfig, Scroller, ScrollerConfig, Search, SearchConfig, Sort, SortConfig, StateProvider, StickyCells, StickyCellsConfig, Store, StoreConfig, Stripe, StripeConfig, SubGrid, SubGridConfig, TabConfig, TimelineBase, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Tree, TreeConfig, TreeGroup, TreeGroupConfig, Widget, XLSColumn } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumAgendaViewProps = {
    // Configs
    /**
     ...
     * @param {EventModel} event the passed event
     * @returns {boolean}
     */
     ...
     * @param {CalendarMixinClass} detail.view The view rendering the event
     * @param {EventModel} detail.eventRecord The event record
     * @param {ResourceModel} detail.resourceRecord The event record
     ...
     * @param {EventModel|EventBar} lhs The left side value to conpare
     * @param {EventModel|EventBar} rhs The right side value to conpare
     * @returns {number}
     */
     ...
     * @param {EventModel} eventRecord The event record for which to create a time string.
     * @param {Date} date The date of the cell in which the event is being rendered.
     * @returns {string}
     */
    eventTimeRenderer? : ((eventRecord: EventModel, date: Date) => string)|string
    extraData? : any
    /**
     ...
     * @param {EventModel} eventRecord The event from which to extract the primary resource.
     * @returns {ResourceModel} The resource to be used to render the event.
     */
    ...
    /**
     * A [MenuConfig](https://bryntum.com/products/calendar/docs/api/Core/widget/Menu#configs) block which configures the [listRangeMenu](#Calendar/widget/EventList#property-listRangeMenu) property which
     ...
     * @param {ResourceModel} event.resourceRecord The resource if the UI includes a resource.
     ...
     * @param {object} event Event object
     * @param {EventModel[]} event.events The events to be shown for the passed date
     ...
     * @param {EventModel} event.eventRecord The event record being propagated.
     ...
     */
    onRangeChange? : ((event: { source: TimelineBase, old: { startDate: Date, endDate: Date }, new: { startDate: Date, endDate: Date } }) => void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {AgendaView} event.source The triggering instance.
     */
...
export class BryntumAgendaView extends React.Component<BryntumAgendaViewProps> {

    static instanceClass = AgendaView;

    static instanceName = 'AgendaView';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumAgendaViewProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-agenda-view-container`;
        return (
