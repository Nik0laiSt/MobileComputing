/**
 * React wrapper for Bryntum DayResourceView
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { ActionButtonsConfig, AlignSpec, Base, CalendarMixin, CalendarRow, CalendarRowConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DayCell, DayResourceView, DayResourceViewListeners, DayView, DomConfig, DurationConfig, EventBar, EventModel, FluidDayLayoutConfig, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, OverflowPopupConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, TimelineBase, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Widget } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumDayResourceViewProps = {
    // Configs
    /**
     ...
     * @param {object} event Event object
     * @param {DayView} event.source The triggering instance.
     */
...
export class BryntumDayResourceView extends React.Component<BryntumDayResourceViewProps> {

    static instanceClass = DayResourceView;

    static instanceName = 'DayResourceView';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumDayResourceViewProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-day-resource-view-container`;
        return (
