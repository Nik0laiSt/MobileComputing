...
import { AlignSpec, Base, Button, ButtonListeners, ContainerItemConfig, DomConfig, KeyMapConfig, MaskConfig, Menu, MenuItemConfig, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/calendar';
...
export type BryntumButtonProps = {
     ...
     */
    onBeforeToggle? : ((event: { source: Button, pressed: boolean, userAction: boolean }) => Promise<boolean>|boolean|void)|string
    /**
