...
export type BryntumSchedulerBaseProps = {
     ...
     * @param {DependencyModel} event.dependencyRecord The dependency about to be saved
     */
    onAfterDependencySave? : ((event: { source: Scheduler, dependencyRecord: DependencyModel }) => void)|string
    /**
     ...
     * @param {EventModel} event.eventRecord The event record being created
     * @param {ResourceModel} event.resourceRecord The resource record
     * @param {HTMLElement} event.eventElement The element representing the created event record
     */
    onAfterDragCreate? : ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, eventElement: HTMLElement }) => void)|string
    /**
     * Fired on the owning Scheduler after event drop
     * @param {object} event Event object
     * @param {Scheduler} event.source
     * @param {AssignmentModel[]} event.assignmentRecords
     * @param {EventModel[]} event.eventRecords
     * @param {boolean} event.valid
     * @param {object} event.context
     * @param {MouseEvent} event.domEvent Browser event
     */
    onAfterEventDrop? : ((event: { source: Scheduler, assignmentRecords: AssignmentModel[], eventRecords: EventModel[], valid: boolean, context: object, domEvent: MouseEvent }) => void)|string
    /**
     ...
     * @param {EventModel} event.eventRecord The record about to be saved
     */
     ...
     * @param {AssignmentModel[]} event.selected An array of the Assignments added to the selection.
     * @param {AssignmentModel[]} event.deselected An array of the Assignments removed from the selection.
     * @param {AssignmentModel[]} event.selection The new selection.
     */
    onAssignmentSelectionChange? : ((event: { action: 'select'|'deselect'|'update'|'clear', selected: AssignmentModel[], deselected: AssignmentModel[], selection: AssignmentModel[] }) => void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source The Scheduler instance
     * @param {EventModel[]} event.eventRecords The records about to be deleted
     ...
     */
    onBeforeAssignmentDelete? : ((event: { source: Scheduler, eventRecords: EventModel[], context: { finalize: { removeRecords?: boolean } } }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * @param {EventModel[]} event.selected An array of assignments that will be added to the selection.
     * @param {EventModel[]} event.deselected An array of assignments that will be removed from the selection.
     * @param {EventModel[]} event.selection The currently selected assignments, before applying `selected` and `deselected`.
     */
     ...
     * @param {Field} event.editorContext.editor The input field that the column is configured with (see [field](https://bryntum.com/products/calendar/docs/api/Grid/column/Column#config-field)). This property mey be replaced to be a different [field](https://bryntum.com/products/calendar/docs/api/Core/widget/Field) in the handler, to take effect just for the impending edit.
     ...
     * @param {DependencyEdit} event.dependencyEdit The dependency edit feature
     * @param {DependencyModel} event.dependencyRecord The dependency about to be added
     */
    onBeforeDependencyAdd? : ((event: { source: Scheduler, dependencyEdit: DependencyEdit, dependencyRecord: DependencyModel }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source The scheduler instance
     * @param {DependencyModel} event.dependencyRecord The dependency record about to be deleted
     */
    onBeforeDependencyDelete? : ((event: { source: Scheduler, dependencyRecord: DependencyModel }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source The scheduler or Gantt instance
     * @param {DependencyEdit} event.dependencyEdit The dependencyEdit feature
     * @param {DependencyModel} event.dependencyRecord The record about to be shown in the editor.
     */
    onBeforeDependencyEdit? : ((event: { source: Scheduler, dependencyEdit: DependencyEdit, dependencyRecord: DependencyModel }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     */
    onBeforeDependencyEditShow? : ((event: { source: Scheduler, dependencyEdit: DependencyEdit, dependencyRecord: DependencyModel, editor: Popup }) => void)|string
    /**
     ...
     */
    onBeforeDependencySave? : ((event: { source: Scheduler, dependencyRecord: DependencyModel, values: object }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source
     * @param {ResourceModel} event.resourceRecord
     * @param {Date} event.date The datetime associated with the drag start point.
     */
    onBeforeDragCreate? : ((event: { source: Scheduler, resourceRecord: ResourceModel, date: Date }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     */
    onBeforeDragCreateFinalize? : ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, eventElement: HTMLElement, context: { startDate: Date, endDate: Date, async: boolean, finalize: Function } }) => void)|string
    /**
     * Fires before an event is added. Can be triggered by schedule double click or drag create action.
     * @param {object} event Event object
     * @param {Scheduler} event.source The Scheduler instance
     * @param {EventModel} event.eventRecord The record about to be added
     * @param {ResourceModel[]} event.resourceRecords Resources that the record is assigned to
     * @param {AssignmentModel[]} event.assignmentRecords The assignment records
     */
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source Scheduler instance
     * @param {EventModel} event.eventRecord Event record the drag starts from
     * @param {ResourceModel} event.resourceRecord Resource record the drag starts from
     * @param {EventModel[]} event.eventRecords Event records being dragged
     * @param {AssignmentModel[]} event.assignmentRecords Assignment records being dragged
     * @param {MouseEvent} event.domEvent Browser event
     */
    onBeforeEventDrag? : ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], domEvent: MouseEvent }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * @param {EventModel[]} event.context.eventRecords Event records being dragged
     * @param {AssignmentModel[]} event.context.assignmentRecords Assignment records being dragged
     * @param {EventModel} event.context.targetEventRecord Event record for drop target
     * @param {ResourceModel} event.context.newResource Resource record for drop target
     ...
     * @param {MouseEvent} event.domEvent Browser event
     */
    onBeforeEventDropFinalize? : ((event: { source: Scheduler, context: { dropData: DropData, async: boolean, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], targetEventRecord: EventModel, newResource: ResourceModel, valid: boolean, finalize: Function }, domEvent: MouseEvent }) => void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source The scheduler
     * @param {SchedulerEventEdit} event.eventEdit The eventEdit feature
     * @param {EventModel} event.eventRecord The record about to be shown in the event editor.
     * @param {ResourceModel} event.resourceRecord The Resource record for the event. If the event is being created, it will not contain a resource, so this parameter specifies the resource the event is being created for.
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source Scheduler instance
     * @param {EventModel} event.eventRecord Event record being resized
     ...
     */
    onBeforeEventResize? : ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, event: MouseEvent }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     */
    onBeforeEventResizeFinalize? : ((event: { source: Scheduler, context: object, eventRecord: EventModel, startDate: Date, endDate: Date, originalStartDate: Date, originalEndDate: Date, async: boolean, finalize: Function, event: Event, resizeData: EventResizeData[] }) => void)|string
    /**
     ...
     * @param {Scheduler} event.source The scheduler instance
     * @param {EventModel} event.eventRecord The record about to be saved
     * @param {ResourceModel[]} event.resourceRecords The resources to which the event is assigned
     * @param {object} event.values The new values
     ...
     * @param {object} event Event object
     * @param {string} event.action One of the actions 'select', 'deselect', 'update', 'clear'
     * @param {EventModel[]} event.selected An array of events that will be added to the selection.
     * @param {EventModel[]} event.deselected An array of events that will be removed from the selection.
     * @param {EventModel[]} event.selection The currently selected events, before applying `selected` and `deselected`.
     */
     ...
     * @param {object} event Event object
     * @param {Model} event.groupRecord [DEPRECATED] Use `groupRecords` param instead
     * @param {Model[]} event.groupRecords The group records being toggled
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source The scheduler
     * @param {DependencyModel} event.dependency
     * @param {MouseEvent} event.event
     */
    onDependencyClick? : ((event: { source: Scheduler, dependency: DependencyModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event
     */
    onDependencyContextMenu? : ((event: { source: Scheduler, dependency: DependencyModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event
     */
    onDependencyDblClick? : ((event: { source: Scheduler, dependency: DependencyModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {Scheduler} event.source
     * @param {Record<string, MenuItemConfig>} event.items Menu item configs
     * @param {DependencyModel} event.dependencyRecord Dependency record for which the menu was triggered
     * @param {HTMLElement} event.element
     * @param {MouseEvent} event.event Pointer event which triggered the context menu (if any)
     */
    onDependencyMenuBeforeShow? : ((event: { source: Scheduler, items: Record<string, MenuItemConfig>, dependencyRecord: DependencyModel, element: HTMLElement, event?: MouseEvent }) => Promise<boolean>|boolean|void)|string
    /**
     * This event fires on the owning Scheduler when an item is selected in the context menu.
     * @param {object} event Event object
     * @param {Scheduler} event.source
     * @param {DependencyModel} event.dependencyRecord Dependency record for which the menu was triggered
     * @param {MenuItem} event.item The menu item
     * @param {HTMLElement} event.element The dependency element
     */
    onDependencyMenuItem? : ((event: { source: Scheduler, dependencyRecord: DependencyModel, item: MenuItem, element: HTMLElement }) => void)|string
    /**
     ...
     * @param {HTMLElement} event.element The dependency element
     */
    onDependencyMenuShow? : ((event: { source: Scheduler, menu: Menu, dependencyRecord: DependencyModel, element: HTMLElement }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event
     */
    onDependencyMouseOut? : ((event: { source: Scheduler, dependency: DependencyModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event
     */
    onDependencyMouseOver? : ((event: { source: Scheduler, dependency: DependencyModel, event: MouseEvent }) => void)|string
    /**
     * Fired on the owning Scheduler/Gantt when asynchronous dependency validation completes
     * @param {object} event Event object
     * @param {TimeSpan} event.source The source task
     * @param {TimeSpan} event.target The target task
     * @param {number} event.dependencyType The dependency type, see [Type](https://bryntum.com/products/calendar/docs/api/Scheduler/model/DependencyBaseModel#property-Type-static)
     */
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source
     * @param {EventModel} event.eventRecord The new `EventModel` record.
     * @param {ResourceModel} event.resourceRecord The resource for the row in which the event is being created.
     ...
     */
    onDragCreateEnd? : ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, event: MouseEvent, eventElement: HTMLElement }) => void)|string
    /**
     ...
     */
    onDragCreateStart? : ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, eventElement: HTMLElement }) => void)|string
    /**
     ...
     * @param {EventModel} event.eventRecord The new event record.
     * @param {ResourceModel} event.resourceRecord The resource assigned to the new event.
     */
    onEventAutoCreated? : ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel }) => void)|string
    /**
     * Triggered for click on an event.
     * @param {object} event Event object
     * @param {Scheduler} event.source This Scheduler
     * @param {EventModel} event.eventRecord Event record
     * @param {AssignmentModel} event.assignmentRecord Assignment record
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventClick? : ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventContextMenu? : ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventDblClick? : ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {ResourceModel} event.resourceRecord Resource record the drag started from
     * @param {ResourceModel} event.newResource Resource at the current location
     * @param {object} event.context
     * @param {boolean} event.context.valid Set this to `false` to signal that the current drop position is invalid.
     * @param {MouseEvent} event.domEvent Browser event
     */
    onEventDrag? : ((event: { source: Scheduler, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], startDate: Date, endDate: Date, resourceRecord: ResourceModel, newResource: ResourceModel, context: { valid: boolean }, domEvent: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.domEvent Browser event
     */
    onEventDragAbort? : ((event: { source: Scheduler, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], domEvent: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.domEvent Browser event
     */
    onEventDragStart? : ((event: { source: Scheduler, resourceRecord: ResourceModel, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], domEvent: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.domEvent Browser event
     */
    onEventDrop? : ((event: { source: Scheduler, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], externalDropTarget: HTMLElement, isCopy: boolean, context: { targetEventRecord: EventModel, newResource: ResourceModel }, domEvent: MouseEvent }) => void)|string
    /**
     ...
     * @param {EventModel} event.record The record
     */
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source This Scheduler
     * @param {EventModel[]} event.eventRecords The selected event records
     * @param {AssignmentModel[]} event.assignmentRecords The selected assignment records
     * @param {KeyboardEvent} event.event Browser event
     */
    onEventKeyDown? : ((event: { source: Scheduler, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], event: KeyboardEvent }) => void)|string
    /**
     ...
     * @param {KeyboardEvent} event.event Browser event
     */
    onEventKeyUp? : ((event: { source: Scheduler, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], event: KeyboardEvent }) => void)|string
    /**
     ...
     * @param {Scheduler} event.source
     * @param {Record<string, MenuItemConfig>} event.items Menu item configs
     * @param {EventModel} event.eventRecord Event record for which the menu was triggered
     * @param {ResourceModel} event.resourceRecord Resource record
     * @param {AssignmentModel} event.assignmentRecord Assignment record, if assignments are used
     ...
     * @param {EventModel} event.eventRecord
     * @param {ResourceModel} event.resourceRecord
     * @param {AssignmentModel} event.assignmentRecord Assignment record, if assignments are used
     * @param {HTMLElement} event.eventElement
     */
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseDown? : ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseEnter? : ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseLeave? : ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseOut? : ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseOver? : ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseUp? : ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     */
    onEventPartialResize? : ((event: { source: Scheduler, eventRecord: EventModel, startDate: Date, endDate: Date, element: HTMLElement, resizeData: EventResizeData[] }) => void)|string
    /**
     ...
     * @param {EventResizeData[]} event.resizeData Resize data for selected events
     */
    onEventResizeEnd? : ((event: { source: Scheduler, changed: boolean, eventRecord: EventModel, resizeData: EventResizeData[] }) => void)|string
    /**
     ...
     * @param {ResourceModel} event.resourceRecord Resource record the resize starts within
     * @param {MouseEvent} event.event Browser event
     * @param {EventResizeData[]} event.resizeData Resize data for selected events. Only available when [resizeSelected](https://bryntum.com/products/calendar/docs/api/Scheduler/feature/EventResize#config-resizeSelected) is `true`
     */
    onEventResizeStart? : ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, event: MouseEvent, resizeData: EventResizeData[] }) => void)|string
    /**
     * Fired any time there is a change to the events selected in the Scheduler.
     * @param {object} event Event object
     * @param {'select'|'deselect'|'update'|'clear'} event.action One of the actions 'select', 'deselect', 'update', 'clear'
     * @param {EventModel[]} event.selected An array of the Events added to the selection.
     * @param {EventModel[]} event.deselected An array of the Event removed from the selection.
     * @param {EventModel[]} event.selection The new selection.
     */
    onEventSelectionChange? : ((event: { action: 'select'|'deselect'|'update'|'clear', selected: EventModel[], deselected: EventModel[], selection: EventModel[] }) => void)|string
    /**
     ...
     * @param {EventModel[]} event.eventRecords The event records about to be pasted
     * @param {AssignmentModel[]} event.assignmentRecords The assignment records about to be pasted
     * @param {EventModel[]} event.originalEventRecords The event records that were copied
     * @param {AssignmentModel[]} event.originalAssignmentRecords The assignment records that were copied
     * @param {Date} event.date The paste date
     * @param {ResourceModel} event.resourceRecord The target resource record
     * @param {boolean} event.isCut `true` if this is a cut action
     ...
     * @param {object} event Event object
     * @param {Scheduler} event.source This Scheduler
     * @param {EventModel} event.eventRecord The event record
     * @param {ResourceModel} event.resourceRecord The resource record
     * @param {AssignmentModel} event.assignmentRecord The assignment record
     ...
     */
    onReleaseEvent? : ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, assignmentRecord: AssignmentModel, renderData: object, element: HTMLElement }) => void)|string
    /**
     ...
     * @param {ResourceModel} event.resourceRecord The resource record
     * @param {AssignmentModel} event.assignmentRecord The assignment record
     * @param {object} event.renderData An object containing details about the event rendering, see [eventRenderer](https://bryntum.com/products/calendar/docs/api/Scheduler/view/mixin/SchedulerEventRendering#config-eventRenderer) for details
     ...
     */
    onResourceHeaderClick? : ((event: { source: Scheduler, resourceRecord: ResourceModel, event: Event }) => void)|string
    /**
     ...
     * @param {Event} event.event The event
     */
    onResourceHeaderContextmenu? : ((event: { source: Scheduler, resourceRecord: ResourceModel, event: Event }) => void)|string
    /**
     ...
     * @param {Event} event.event The event
     */
    onResourceHeaderDblclick? : ((event: { source: Scheduler, resourceRecord: ResourceModel, event: Event }) => void)|string
    /**
     ...
     * @param {Record<string, MenuItemConfig>} event.items Menu item configs
     * @param {Column} event.column Column
     * @param {ResourceModel} event.resourceRecord Record
     */
    onResourceMenuBeforeShow? : ((event: { source: Scheduler, menu: Menu, items: Record<string, MenuItemConfig>, column: Column, resourceRecord: ResourceModel }) => Promise<boolean>|boolean|void)|string
    /**
     * This event fires on the owning scheduler when an item is selected in the context menu.
     * @param {object} event Event object
     * @param {Scheduler} event.source The grid
     * @param {Menu} event.menu The menu
     * @param {MenuItem} event.item Selected menu item
     * @param {ResourceModel} event.record Record
     */
     ...
     * @param {ResourceModel} event.record Record
     */
    onResourceMenuShow? : ((event: { source: Scheduler, menu: Menu, items: Record<string, MenuItemConfig>, record: ResourceModel }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onScheduleClick? : ((event: { source: Scheduler, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onScheduleContextMenu? : ((event: { source: Scheduler, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onScheduleDblClick? : ((event: { source: Scheduler, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onScheduleMouseDown? : ((event: { source: Scheduler, date: Date, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onScheduleMouseEnter? : ((event: { source: Scheduler, date: Date, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onScheduleMouseMove? : ((event: { source: Scheduler, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onScheduleMouseUp? : ((event: { source: Scheduler, date: Date, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string
    /**
