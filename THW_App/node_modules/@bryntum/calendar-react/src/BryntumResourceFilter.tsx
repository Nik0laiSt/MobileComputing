...
import { AlignSpec, Base, Collection, CollectionConfig, DomConfig, EventStore, Field, KeyMapConfig, List, MaskConfig, Model, ModelConfig, Rectangle, ResourceFilter, ResourceFilterListeners, ResourceModel, Scroller, ScrollerConfig, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/calendar';
...
export type BryntumResourceFilterProps = {
     ...
     * function returning the value of the record´s [displayField](https://bryntum.com/products/calendar/docs/api/Core/widget/List#config-displayField)
     * @param {Model} record The record
     * @returns {string}
     */
     ...
     * @param {Field} event.source This ResourceFilter
     */
