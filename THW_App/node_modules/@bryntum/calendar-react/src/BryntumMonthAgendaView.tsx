/**
 * React wrapper for Bryntum MonthAgendaView
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { AgendaView, AgendaViewConfig, AlignSpec, Base, CalendarMixin, CalendarPanel, Container, ContainerItemConfig, ContainerLayoutConfig, DatePicker, DayAgendaView, DayAgendaViewConfig, DayView, DayViewConfig, DomConfig, DurationConfig, EventBar, EventModel, EventStore, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Month, MonthAgendaView, MonthAgendaViewListeners, MonthConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Widget } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumMonthAgendaViewProps = {
    // Configs
    /**
...
export class BryntumMonthAgendaView extends React.Component<BryntumMonthAgendaViewProps> {

    static instanceClass = MonthAgendaView;

    static instanceName = 'MonthAgendaView';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumMonthAgendaViewProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-month-agenda-view-container`;
        return (
