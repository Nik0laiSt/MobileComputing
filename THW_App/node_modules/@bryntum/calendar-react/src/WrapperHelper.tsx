...
import { DomHelper, StringHelper, Widget } from '@bryntum/calendar';
...
function devWarning(clsName: string, msg: string): void {
    ...
    if (window.bryntum && window.bryntum.isTestEnv || process.env.NODE_ENV === 'development') {
        console.warn(
            ...
            'Please check React integration guide: https://bryntum.com/products/calendar/docs/guide/Calendar/integration/react/guide'
        );
    }
}
    ...
    if (isRelease) {
        ...
        if (jsx) {
            ...
            const
                ...
                // https://github.com/bryntum/support/issues/10091
