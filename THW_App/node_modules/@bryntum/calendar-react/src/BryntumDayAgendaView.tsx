/**
 * React wrapper for Bryntum DayAgendaView
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { ActionButtonsConfig, AlignSpec, Base, CalendarMixin, CalendarRow, CalendarRowConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DayAgendaView, DayAgendaViewListeners, DayCell, DayView, DomConfig, DurationConfig, EventBar, EventModel, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, OverflowPopupConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, TimelineBase, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Widget } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumDayAgendaViewProps = {
    // Configs
    /**
...
export class BryntumDayAgendaView extends React.Component<BryntumDayAgendaViewProps> {

    static instanceClass = DayAgendaView;

    static instanceName = 'DayAgendaView';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumDayAgendaViewProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-day-agenda-view-container`;
        return (
