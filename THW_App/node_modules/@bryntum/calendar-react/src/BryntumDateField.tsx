...
import { AlignSpec, Base, ContainerItemConfig, DateField, DateFieldListeners, DatePickerConfig, DomConfig, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, Scroller, TabConfig, TooltipConfig, Widget } from '@bryntum/calendar';
...
export type BryntumDateFieldProps = {
     ...
     * @param {object} event Event object
     * @param {DateField} event.source This DateField
