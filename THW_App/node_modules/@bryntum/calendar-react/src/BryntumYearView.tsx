/**
 * React wrapper for Bryntum YearView
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { AlignSpec, Base, CalendarMixin, Container, ContainerItemConfig, ContainerLayoutConfig, DayCell, DomConfig, EventBar, EventModel, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, OverflowPopup, OverflowPopupConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Widget, YearView, YearViewListeners } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumYearViewProps = {
    // Configs
    /**
     ...
     * @param {EventModel>} cellData.events The array of events in this cell
     ...
     * @param {object} event Event object
     * @param {YearView} event.source The triggering instance.
     */
...
export class BryntumYearView extends React.Component<BryntumYearViewProps> {

    static instanceClass = YearView;

    static instanceName = 'YearView';
    ...
    render(): React.ReactNode {
        ...
        const className = `b-react-year-view-container`;
        return (
