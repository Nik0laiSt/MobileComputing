...
import { AlignSpec, Base, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, Editor, EditorListeners, InputFieldConfig, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/calendar';
...
export type BryntumEditorProps = {
     ...
     * @param {boolean|object} event.matchSize Whether to match the target size. See [matchSize](https://bryntum.com/products/calendar/docs/api/Core/widget/Editor#config-matchSize)
     * @param {boolean} event.matchSize.width Match width
     * @param {boolean} event.matchSize.height Match height
     * @param {boolean} event.matchFont Whether to match the target's font. See [matchFont](https://bryntum.com/products/calendar/docs/api/Core/widget/Editor#config-matchFont)
