/**
 * React wrapper for Bryntum MonthView
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { AlignSpec, Base, CalendarMixin, CalendarPanel, Container, ContainerItemConfig, ContainerLayoutConfig, DatePicker, DayCell, DomConfig, EventBar, EventModel, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Month, MonthConfig, MonthView, MonthViewListeners, OverflowPopup, OverflowPopupConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Widget } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumMonthViewProps = {
    // Configs
    /**
     ...
     * @param {object} renderData
     * @param {HTMLElement} renderData.cell The header element
     * @param {number} renderData.day The day number conforming to the specified [weekStartDay](https://bryntum.com/products/calendar/docs/api/Core/widget/CalendarPanel#config-weekStartDay). Will be in the range `0` to `6`
     ...
     * @param {OverflowPopup} event.overflowPopup The overflow `Popup`.
     */
...
export class BryntumMonthView extends React.Component<BryntumMonthViewProps> {

    static instanceClass = MonthView;

    static instanceName = 'MonthView';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumMonthViewProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-month-view-container`;
        return (
