...
export type BryntumFieldFilterPickerProps = {
     ...
     * @param {any[]} event.filter The [CollectionFilter](https://bryntum.com/products/calendar/docs/api/Core/util/CollectionFilter) configuration object for the filter represented by this [FieldFilterPicker](https://bryntum.com/products/calendar/docs/api/Core/widget/FieldFilterPicker).
