/**
 * React wrapper for Bryntum DayView
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { ActionButtonsConfig, AlignSpec, Base, CalendarMixin, CalendarRow, CalendarRowConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DayCell, DayView, DayViewListeners, DomConfig, DurationConfig, EventBar, EventModel, FluidDayLayoutConfig, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, OverflowPopupConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, TimelineBase, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Widget } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumDayViewProps = {
    // Configs
    /**
...
export class BryntumDayView extends React.Component<BryntumDayViewProps> {

    static instanceClass = DayView;

    static instanceName = 'DayView';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumDayViewProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-day-view-container`;
        return (
