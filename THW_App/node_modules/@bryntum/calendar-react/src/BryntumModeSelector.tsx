/**
 * React wrapper for Bryntum ModeSelector
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { AlignSpec, Base, Button, ButtonGroup, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, ModeSelector, ModeSelectorListeners, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumModeSelectorProps = {
    // Configs
    /**
...
export class BryntumModeSelector extends React.Component<BryntumModeSelectorProps> {

    static instanceClass = ModeSelector;

    static instanceName = 'ModeSelector';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumModeSelectorProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-mode-selector-container`;
        return (
