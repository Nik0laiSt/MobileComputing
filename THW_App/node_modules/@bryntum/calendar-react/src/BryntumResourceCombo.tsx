...
import { AlignSpec, Base, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, DomConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, ResourceCombo, ResourceComboListeners, Scroller, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/calendar';
...
export type BryntumResourceComboProps = {
     ...
     * not [readOnly](https://bryntum.com/products/calendar/docs/api/Core/widget/Field#config-readOnly). The trigger is available in the [triggers](#Core/widget/Field#property-triggers) object
     * under the name `clear`. May also be an object which configures the `clear`
     * [trigger](https://bryntum.com/products/calendar/docs/api/Core/widget/Field#property-triggers).
     */
     ...
     * @param {any} event.value The [value](https://bryntum.com/products/calendar/docs/api/Core/widget/Combo#config-valueField) of the selected record
     * @param {Model} event.record Selected record
     * @param {Model[]} event.records Selected records as an array if [multiSelect](https://bryntum.com/products/calendar/docs/api/Core/widget/Combo#config-multiSelect) is `true`
