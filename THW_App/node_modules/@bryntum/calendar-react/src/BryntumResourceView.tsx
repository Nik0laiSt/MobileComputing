/**
 * React wrapper for Bryntum ResourceView
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { AlignSpec, Base, CalendarMixin, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, DurationConfig, EventBar, EventModel, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, ResourceView, ResourceViewListeners, Scroller, ScrollerConfig, StateProvider, TabConfig, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Widget } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumResourceViewProps = {
    // Configs
    /**
     ...
     * @param {ResourceModel} resource Displayed resource
     ...
     * @param {object} event Event object
     * @param {ResourceView} event.source The triggering instance.
     */
...
export class BryntumResourceView extends React.Component<BryntumResourceViewProps> {

    static instanceClass = ResourceView;

    static instanceName = 'ResourceView';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumResourceViewProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-resource-view-container`;
        return (
