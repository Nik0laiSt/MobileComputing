/**
 * React wrapper for Bryntum CalendarDatePicker
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { AlignSpec, Base, CalendarDatePicker, CalendarDatePickerListeners, CalendarMixin, CalendarPanel, Container, ContainerItemConfig, ContainerLayoutConfig, DatePicker, DomConfig, EventModel, EventStore, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Month, MonthConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Widget } from '@bryntum/calendar';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumCalendarDatePickerProps = {
    // Configs
    /**
...
export class BryntumCalendarDatePicker extends React.Component<BryntumCalendarDatePickerProps> {

    static instanceClass = CalendarDatePicker;

    static instanceName = 'CalendarDatePicker';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumCalendarDatePickerProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-calendar-date-picker-container`;
        return (
